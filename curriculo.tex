...
\subsection*{Auxiliar Técnico em Química – DER (2009 – 2010)}
\begin{itemize}
    \item Controle de qualidade de materiais rodoviários e elaboração de relatórios técnicos.
    \item Aplicação de métodos quantitativos e padronização de processos laboratoriais.
\end{itemize}
