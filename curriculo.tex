...
\begin{center}
    ...
    {\large Engenheiro de ML | Ciência de Dados | HPC} \\[0.2cm]
...
\textbf{MBA em Data Science \& Analytics} — USP/ESALQ \hfill \textbf{2024–2026} (em andamento) \\

\textbf{Bacharelado em Física} — USP/IFSC \hfill \textbf{2017–2023} \\
...
\begin{itemize}
    \item \textbf{Engenharia de Dados}: construção e otimização de pipelines ETL/ELT, integração com sistemas transacionais, versionamento de dados.
    ...
    \item \textbf{Orquestração e MLOps}: Git, Docker, GitHub Actions; familiaridade com Prefect.
